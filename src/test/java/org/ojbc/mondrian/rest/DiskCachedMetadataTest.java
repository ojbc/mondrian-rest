...
@TestPropertySource(properties = { "preCacheMetadata=true", "metadataCacheHeapTierEntries=1" })
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD)
public class DiskCachedMetadataTest extends AbstractMondrianRestControllerTest {
	
	private final Log log = LogFactory.getLog(DiskCachedMetadataTest.class);
